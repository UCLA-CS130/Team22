...
case `uname` in
  ...
  Darwin)
    ...
    clang++ -std=c++11 -stdlib=libc++ -isystem ${GTEST_DIR}/include -pthread connection_test.cc connection.cpp ${GTEST_DIR}/src/gtest_main.cc libgtest.a -o connection -lboost_system;;
  *)
