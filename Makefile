...
DEPS=server.h connection.h config_parser.h http_parser.h request_handler.h echo_handler.h
OBJ=server.o connection.o config_parser.o http_parser.o echo_handler.o
